...
Cada desafio é desenvolvido seguindo um fluxo sequencial e lógico:
...
| 02 | Situação do aluno | [`desafio02_situacao_aluno.py`](desafio02_situacao_aluno.py) | Decisão múltipla | ⬜ |
...
| 04 | Tabuada | [`desafio04_tabuada.py`](desafio04_tabuada.py) | `for` e `range()` | ⬜ |
...
| 08 | Calculadora com menu | [`desafio08_calculadora_menu.py`](desafio08_calculadora_menu.py) | `while`, `break`, `continue` | ⬜ |
| 09 | Fibonacci | [`desafio09_fibonacci.py`](desafio09_fibonacci.py) | Sequências e repetição | ⬜ |
| 10 | Número primo | [`desafio10_numero_primo.py`](desafio10_numero_primo.py) | Divisibilidade e `break` | ⬜ |
| 11 | Estatísticas da turma | [`desafio11_estatisticas_turma.py`](desafio11_estatisticas_turma.py) | Contadores e acumuladores | ⬜ |
...
[`desafio01_classificador_numero.py`](desafio01_classificador_numero.py)
...
[`desafio02_situacao_aluno.py`](desafio02_situacao_aluno.py)
...
[`desafio03_maior_menor_cinco_numeros.py`](desafio03_maior_menor_cinco_numeros.py)
...
[`desafio04_tabuada.py`](desafio04_tabuada.py)
...
[`desafio05_soma_pares_intervalo.py`](desafio05_soma_pares_intervalo.py)
...
[`desafio06_contador_sinais.py`](desafio06_contador_sinais.py)
...
[`desafio07_senha_tres_tentativas.py`](desafio07_senha_tres_tentativas.py)
...
[`desafio08_calculadora_menu.py`](desafio08_calculadora_menu.py)
...
[`desafio09_fibonacci.py`](desafio09_fibonacci.py)
...
[`desafio10_numero_primo.py`](desafio10_numero_primo.py)
...
[`desafio11_estatisticas_turma.py`](desafio11_estatisticas_turma.py)
...
```bat
python semana-02\03-desafios-extras\desafio04_tabuada.py
```

Calculadora:

```bat
python semana-02\03-desafios-extras\desafio08_calculadora_menu.py
```
...
Cada desafio deverá seguir esta sequência:
...
Cada desafio será versionado individualmente.

Exemplo:

```bat
git status
git add 03-desafios-extras/desafio01_classificador_numero.py
git status
...
Ao concluir esta etapa, deverão estar consolidados conhecimentos relacionados a:
...
A tabela será atualizada progressivamente conforme cada desafio for concluído.
